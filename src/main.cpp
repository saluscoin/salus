...
#if defined(NDEBUG)
# error "SaluS cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "SaluS Signed Message:\n";
...
bool CTransaction::CheckTransaction() const
{
    ...
    if (!IsCoinBase() && !IsCoinStake() && !payFoundation) {
