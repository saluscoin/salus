...
{
    resize(950+95, 550);
    setWindowTitle(tr("SaluS") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    addressesDialog = new AddressesDialog(this);
    ...
    centralStackedWidget->addWidget(addressesDialog);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a SaluS address"));
    ...
    connect(addressesPageAction, &QAction::triggered, this, &BitcoinGUI::gotoAddressesPage);
    //connect(addressesPageAction, &QAction::triggered, this, &BitcoinGUI::showNormalIfMinimized);
    ...
    aboutAction = new QAction(tr("&About SaluS"), this);
    aboutAction->setToolTip(tr("Show information about SaluS"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for SaluS"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->addAction(addressesPageAction);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("SaluS client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::setWalletModel(WalletModel *walletModel)
{
    ...
    if(walletModel)
    {
        ...
        addressesDialog->SetWalletModel(walletModel);
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("SaluS client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SaluS network", "", count));
}
...
{
    addressesPageAction->setChecked(true);
    centralStackedWidget->setCurrentWidget(addressesDialog);
    addressesDialog->ResetSelections();
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid SaluS address or malformed URI parameters."));
    }
