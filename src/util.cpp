...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "SaluS";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "salus.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "salusd.pid"));
